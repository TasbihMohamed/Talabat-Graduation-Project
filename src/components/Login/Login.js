  ...
  return (
    <>
      ...
      <div id="main" className="d-flex justify-content-center mx-5 px-5"
       >
       <button className="btngoogle " style={{padding:"5px 10px"}}>
          <img src={GoogleIcon} alt="" style={{width:"2rem" ,
        }}/>
        <span>Continue wih google</span>  
        </button>
      </div>
      <br></br>
      <div className="d-flex justify-content-around ffff">
      <button className="btnfacebook" style={{padding:"5px 5px"}}>
          <img src={FacebookIcon} alt="" style={{width:"2rem"}}/>
          <span> Continue wih Facebook
</span> 
        </button>
      ...
      <div className="container d-flex justify-content-center ">
        <div className="row p-3">
          <button onClick={login} id="createB" className="btn-xl">
            Login
          </button>
        </div>
      </div>
      ...
      <div className="container d-flex justify-content-center ">
        <div className="row p-3">
          <p>
            ...
            <Link to={"/Rigester"}>
              <span id="sp2">Create an account</span>
            </Link>
          </p>
        </div>
      </div>
